...
def main():
    ...
    model_b = ResNet18(num_classes=100)
...
if __name__ == "__main__":
  main()
# CUDA_VISIBLE_DEVICES=3 python resnet18_cifar100_weight_merging_split.py --checkpoint_a ~/project/model_folding_public/weights/resnet18_CIFAR100_split_a.pth --checkpoint_b ~/project/model_folding_public/weights/resnet18_CIFAR100_split_b.pth