...
def main():
    ...
    test_merge(copy.deepcopy(model_a), copy.deepcopy(model_a).state_dict(), copy.deepcopy(model_b), copy.deepcopy(model_b).state_dict(), test_loader, train_loader,  fuse_channel_vgg11_clustering)


if __name__ == "__main__":
  main()
# CUDA_VISIBLE_DEVICES=3 python vgg11_cifar10_weight_merging.py --checkpoint_a ~/project/model_folding_public/weights/vgg11_bn_CIFAR10_init1.pth --checkpoint_b ~/project/model_folding_public/weights/vgg11_bn_CIFAR10_init2.pth